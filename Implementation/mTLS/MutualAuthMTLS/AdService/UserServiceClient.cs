...
namespace UserApi {
    ...
    public partial class UserApiClient {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<User> UsersAsync(int id) {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<User> UsersAsync(int id, System.Threading.CancellationToken cancellationToken) {
            if (id == null)
