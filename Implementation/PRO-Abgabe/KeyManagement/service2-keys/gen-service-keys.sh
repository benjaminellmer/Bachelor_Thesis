...
openssl genrsa -aes256 -passout pass:"$passwordService" -out service.key

# Create certificate signing request
openssl req -passin pass:"$passwordService" -new -key service.key -out service.csr -subj "/CN=$subject"

# Sign certificate by CA
openssl x509 -req -passin pass:"$passwordCA" -days 365 -in service.csr -CA ../ca-keys/ca.crt -CAkey ../ca-keys/ca.key -set_serial -01 -out service.crt
