...
\end{enumerate}
After the TLS handshake, both participants know the secret used to encrypt and decrypt messages.
...
The biggest challenge of mTLS is the key management, which was described in more detail in chapter~\ref{sec:key_management}.
...
Nevertheless, this leads to additional implementation overhead and requires developers specializing in security-related systems.
